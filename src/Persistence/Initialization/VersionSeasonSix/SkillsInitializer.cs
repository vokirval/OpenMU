...
internal class SkillsInitializer : SkillsInitializerBase
{
    ...
    public override void Initialize()
    {
        ...
        this.CreateSkill(SkillNumber.LightningShock, "Lightning Shock", CharacterClasses.AllSummoners, DamageType.Curse, 95, 6, 7, 115, energyRequirement: 823, elementalModifier: ElementalType.Wind, skillType: SkillType.AreaSkillAutomaticHits);
